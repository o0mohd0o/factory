<!-- Modal -->
<div class="modal fade" id="department-daily-report-query" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" id="department-daily-report-form" action="{{ route('departments.dailyReports.show') }}">
            @csrf
...
<script>
    $(document).ready(function() {
        ...
        $('#department-daily-report-form').on('submit', function(e) {
            e.preventDefault();
            let data = new FormData(this);
            let url = $(this).attr('action');
            $('#department-daily-report-query').modal('toggle');
