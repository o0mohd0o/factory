 ...
 <div class="row p-1" style="direction: rtl;">
     <div class="col-2">
         <button class="transfers-navigator" data-transfers-date="{{ $date }}" data-ordering="first"> <i
                 class="fas fa-step-forward"></i> </button>
         <button class="transfers-navigator" data-transfers-date="{{ $date }}" data-ordering="previous"> <i
     ...
     <div class="col-2" style="direction: ltr;">
         <button class="transfers-navigator" data-transfers-date="{{ $date }}" data-ordering="last"> <i
                 class="fas fa-step-backward"></i> </button>
         <button class="transfers-navigator" data-transfers-date="{{ $date }}" data-ordering="next"> <i
         ...
         <div class="row">
             <div class="col-sm-2">
                 <div class="form-group">
                     ...
                     <input type="text" name="date" class="form-control date-picker" data-date-format="yyyy-mm-dd"
                         value="{{ $date }}">
                 </div>
             </div>
         </div>
         ...
         <table id="autocomplete_table" class="printForm create-form autocomplete_table">
             ...
             <tbody class="fs-5">
                 ...
                 <tr>
                     ...
                     <td><input type="text" class="form-control total-loss" name="total_loss" value="0">
                     </td>
                     <td><input type="text" class="form-control total-gain" name="total_gain" value="0">
                     </td>
     ...
     $(document).ready(function() {
         $('.opening-balance').on('click', function(e) {
             ...
             axios.get(url).then((response) => {
                 ...
                 axios.get("{{ route('ajax.openingBalances.create', $department) }}").then((
                     response) => {
                     $('#main-content').html(response.data);
                 });
             });
