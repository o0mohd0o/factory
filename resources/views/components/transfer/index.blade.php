        ...
        <div id="departments-transfer-section">
         ...
         <div class="row p-1" style="direction: rtl;">
             <div class="col-2">
                 ...
                 <button class="transfers-navigator" data-transfers-date="{{ $date }}" data-ordering="previous">
                     ...
                     <tbody class="fs-5">
                         ...
                         <tr>
                             ...
                             <td><input type="text" id="transfer_to_name" data-department={{ $department->id }}
                                     data-field-name="name" class="form-control autocomplete_department"
                                     autofill="off" autocomplete="off" name="transfer_to_name"></td>
